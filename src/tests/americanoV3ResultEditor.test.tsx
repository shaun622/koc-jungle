...
describe('Americano score draft acknowledgements', () => {
  it('requires explicit unfinished confirmation, preserves it through clock updates and locks it for viewers', async () => {
    ...
    event.formatConfig.scoring.allowUnfinished=true;
    ...
    fireEvent.click(screen.getByLabelText(/Finish with score played/));
    ...
    expect(screen.getByLabelText(/Finish with score played/)).toBeDisabled();
  });
